...
/**
 * Thread-safe version of [[org.apache.spark.util.LongAccumulator]].
 *
 * See https://issues.apache.org/jira/browse/SPARK-21425.
 */
case class LongAccumulator(initialValue: Long = 0)
  ...
  override def copy(): AccumulatorV2[Long, Long] = LongAccumulator(value)
